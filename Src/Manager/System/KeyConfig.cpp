...
void KeyConfig::Init(void)
{
	...
	//キャンセル処理
	Add(CONTROL_TYPE::CANCEL, KEY_INPUT_BACK);
	Add(CONTROL_TYPE::CANCEL, KEY_INPUT_ESCAPE);
	Add(CONTROL_TYPE::CANCEL, MOUSE::CLICK_RIGHT);
	Add(CONTROL_TYPE::CANCEL, JOYPAD_BTN::RIGHTBUTTON_DOWN);

	//選択肢の上入力
	Add(CONTROL_TYPE::SELECT_UP, JOYPAD_BTN::LEFTBUTTON_TOP);
	Add(CONTROL_TYPE::SELECT_UP, JOYPAD_STICK::L_STICK_UP);
	Add(CONTROL_TYPE::SELECT_UP, KEY_INPUT_W);

	//選択肢の下入力
	Add(CONTROL_TYPE::SELECT_DOWN, JOYPAD_BTN::LEFTBUTTON_DOWN);
	Add(CONTROL_TYPE::SELECT_DOWN, JOYPAD_STICK::L_STICK_DOWN);
	Add(CONTROL_TYPE::SELECT_DOWN, KEY_INPUT_S);

	//選択肢の右入力
	Add(CONTROL_TYPE::SELECT_RIGHT, JOYPAD_BTN::LEFTBUTTON_RIGHT);
	Add(CONTROL_TYPE::SELECT_RIGHT, JOYPAD_STICK::L_STICK_RIGHT);
	Add(CONTROL_TYPE::SELECT_RIGHT, KEY_INPUT_D);

	//選択肢の左入力
	Add(CONTROL_TYPE::SELECT_LEFT, JOYPAD_BTN::LEFTBUTTON_LEFT);
	Add(CONTROL_TYPE::SELECT_LEFT, JOYPAD_STICK::L_STICK_LEFT);
	Add(CONTROL_TYPE::SELECT_LEFT, KEY_INPUT_A);
	...
	Add(CONTROL_TYPE::PUSH_BUTTON, JOYPAD_BTN::RIGHTBUTTON_DOWN);

	//スペシャルボタン
	Add(CONTROL_TYPE::SPECIAL_BUTTON, MOUSE::CLICK_RIGHT);
	Add(CONTROL_TYPE::SPECIAL_BUTTON, JOYPAD_BTN::RIGHTBUTTON_TOP);
	Add(CONTROL_TYPE::SPECIAL_BUTTON, JOYPAD_BTN::RIGHTBUTTON_LEFT);

	//スピンアタック
	Add(CONTROL_TYPE::SPIN_ATTACK_R, MOUSE::MOVE_RIGHT);
	Add(CONTROL_TYPE::SPIN_ATTACK_R, JOYPAD_STICK::L_STICK_RIGHT);
	Add(CONTROL_TYPE::SPIN_ATTACK_L, MOUSE::MOVE_LEFT);
	Add(CONTROL_TYPE::SPIN_ATTACK_L, JOYPAD_STICK::L_STICK_LEFT);
